...
int main(void)
{
      ...
      if(1 < 2) printf(">> File: %s\n", "main.c"); else if(1 < 3) printf(">> File: %s  Func: %s\n", "main.c", __func__); else if(1 < 4) printf(">> File: %s  Func: %s  Line: %d\n", "main.c", __func__, 37); else printf(">> File: %s  Func: %s  Line: %d  STD:%ld\n", "main.c", __func__, 37, 201112L); printf(">> "); printf("Test Debug level = %d", 1); printf("\n\n");;
      if(2 < 2) printf(">> File: %s\n", "main.c"); else if(2 < 3) printf(">> File: %s  Func: %s\n", "main.c", __func__); else if(2 < 4) printf(">> File: %s  Func: %s  Line: %d\n", "main.c", __func__, 38); else printf(">> File: %s  Func: %s  Line: %d  STD:%ld\n", "main.c", __func__, 38, 201112L); printf(">> "); printf("Test Debug level = %d", 2); printf("\n\n");;
      if(3 < 2) printf(">> File: %s\n", "main.c"); else if(3 < 3) printf(">> File: %s  Func: %s\n", "main.c", __func__); else if(3 < 4) printf(">> File: %s  Func: %s  Line: %d\n", "main.c", __func__, 39); else printf(">> File: %s  Func: %s  Line: %d  STD:%ld\n", "main.c", __func__, 39, 201112L); printf(">> "); printf("Test Debug level = %d", 3); printf("\n\n");;
      if(4 < 2) printf(">> File: %s\n", "main.c"); else if(4 < 3) printf(">> File: %s  Func: %s\n", "main.c", __func__); else if(4 < 4) printf(">> File: %s  Func: %s  Line: %d\n", "main.c", __func__, 40); else printf(">> File: %s  Func: %s  Line: %d  STD:%ld\n", "main.c", __func__, 40, 201112L); printf(">> "); printf("Test Debug level = %d", 4); printf("\n\n");;
   ...
   function3();
      ...
      if(1 < 2) printf(">> File: %s\n", "main.c"); else if(1 < 3) printf(">> File: %s  Func: %s\n", "main.c", __func__); else if(1 < 4) printf(">> File: %s  Func: %s  Line: %d\n", "main.c", __func__, 49); else printf(">> File: %s  Func: %s  Line: %d  STD:%ld\n", "main.c", __func__, 49, 201112L); printf(">> "); printf("Test Debug level = %d", 1); printf("\n\n");;
      if(2 < 2) printf(">> File: %s\n", "main.c"); else if(2 < 3) printf(">> File: %s  Func: %s\n", "main.c", __func__); else if(2 < 4) printf(">> File: %s  Func: %s  Line: %d\n", "main.c", __func__, 50); else printf(">> File: %s  Func: %s  Line: %d  STD:%ld\n", "main.c", __func__, 50, 201112L); printf(">> "); printf("Test Debug level = %d", 2); printf("\n\n");;
      if(3 < 2) printf(">> File: %s\n", "main.c"); else if(3 < 3) printf(">> File: %s  Func: %s\n", "main.c", __func__); else if(3 < 4) printf(">> File: %s  Func: %s  Line: %d\n", "main.c", __func__, 51); else printf(">> File: %s  Func: %s  Line: %d  STD:%ld\n", "main.c", __func__, 51, 201112L); printf(">> "); printf("Test Debug level = %d", 3); printf("\n\n");;
      if(4 < 2) printf(">> File: %s\n", "main.c"); else if(4 < 3) printf(">> File: %s  Func: %s\n", "main.c", __func__); else if(4 < 4) printf(">> File: %s  Func: %s  Line: %d\n", "main.c", __func__, 52); else printf(">> File: %s  Func: %s  Line: %d  STD:%ld\n", "main.c", __func__, 52, 201112L); printf(">> "); printf("Test Debug level = %d", 4); printf("\n\n");;
...
void function1(void)
{
      ...
      if(1 < 2) printf(">> File: %s\n", "main.c"); else if(1 < 3) printf(">> File: %s  Func: %s\n", "main.c", __func__); else if(1 < 4) printf(">> File: %s  Func: %s  Line: %d\n", "main.c", __func__, 61); else printf(">> File: %s  Func: %s  Line: %d  STD:%ld\n", "main.c", __func__, 61, 201112L); printf(">> "); printf("Test Debug level = %d", 1); printf("\n\n");;
      if(2 < 2) printf(">> File: %s\n", "main.c"); else if(2 < 3) printf(">> File: %s  Func: %s\n", "main.c", __func__); else if(2 < 4) printf(">> File: %s  Func: %s  Line: %d\n", "main.c", __func__, 62); else printf(">> File: %s  Func: %s  Line: %d  STD:%ld\n", "main.c", __func__, 62, 201112L); printf(">> "); printf("Test Debug level = %d", 2); printf("\n\n");;
      if(3 < 2) printf(">> File: %s\n", "main.c"); else if(3 < 3) printf(">> File: %s  Func: %s\n", "main.c", __func__); else if(3 < 4) printf(">> File: %s  Func: %s  Line: %d\n", "main.c", __func__, 63); else printf(">> File: %s  Func: %s  Line: %d  STD:%ld\n", "main.c", __func__, 63, 201112L); printf(">> "); printf("Test Debug level = %d", 3); printf("\n\n");;
      if(4 < 2) printf(">> File: %s\n", "main.c"); else if(4 < 3) printf(">> File: %s  Func: %s\n", "main.c", __func__); else if(4 < 4) printf(">> File: %s  Func: %s  Line: %d\n", "main.c", __func__, 64); else printf(">> File: %s  Func: %s  Line: %d  STD:%ld\n", "main.c", __func__, 64, 201112L); printf(">> "); printf("Test Debug level = %d", 4); printf("\n\n");;

}
void function2(void)
{

      if(1 < 2) printf(">> File: %s\n", "main.c"); else if(1 < 3) printf(">> File: %s  Func: %s\n", "main.c", __func__); else if(1 < 4) printf(">> File: %s  Func: %s  Line: %d\n", "main.c", __func__, 70); else printf(">> File: %s  Func: %s  Line: %d  STD:%ld\n", "main.c", __func__, 70, 201112L); printf(">> "); printf("Test Debug level = %d", 1); printf("\n\n");;
      if(2 < 2) printf(">> File: %s\n", "main.c"); else if(2 < 3) printf(">> File: %s  Func: %s\n", "main.c", __func__); else if(2 < 4) printf(">> File: %s  Func: %s  Line: %d\n", "main.c", __func__, 71); else printf(">> File: %s  Func: %s  Line: %d  STD:%ld\n", "main.c", __func__, 71, 201112L); printf(">> "); printf("Test Debug level = %d", 2); printf("\n\n");;
      if(3 < 2) printf(">> File: %s\n", "main.c"); else if(3 < 3) printf(">> File: %s  Func: %s\n", "main.c", __func__); else if(3 < 4) printf(">> File: %s  Func: %s  Line: %d\n", "main.c", __func__, 72); else printf(">> File: %s  Func: %s  Line: %d  STD:%ld\n", "main.c", __func__, 72, 201112L); printf(">> "); printf("Test Debug level = %d", 3); printf("\n\n");;
      if(4 < 2) printf(">> File: %s\n", "main.c"); else if(4 < 3) printf(">> File: %s  Func: %s\n", "main.c", __func__); else if(4 < 4) printf(">> File: %s  Func: %s  Line: %d\n", "main.c", __func__, 73); else printf(">> File: %s  Func: %s  Line: %d  STD:%ld\n", "main.c", __func__, 73, 201112L); printf(">> "); printf("Test Debug level = %d", 4); printf("\n\n");;

}
void function3(void)
{

      if(1 < 2) printf(">> File: %s\n", "main.c"); else if(1 < 3) printf(">> File: %s  Func: %s\n", "main.c", __func__); else if(1 < 4) printf(">> File: %s  Func: %s  Line: %d\n", "main.c", __func__, 79); else printf(">> File: %s  Func: %s  Line: %d  STD:%ld\n", "main.c", __func__, 79, 201112L); printf(">> "); printf("Test Debug level = %d", 1); printf("\n\n");;
      if(2 < 2) printf(">> File: %s\n", "main.c"); else if(2 < 3) printf(">> File: %s  Func: %s\n", "main.c", __func__); else if(2 < 4) printf(">> File: %s  Func: %s  Line: %d\n", "main.c", __func__, 80); else printf(">> File: %s  Func: %s  Line: %d  STD:%ld\n", "main.c", __func__, 80, 201112L); printf(">> "); printf("Test Debug level = %d", 2); printf("\n\n");;
      if(3 < 2) printf(">> File: %s\n", "main.c"); else if(3 < 3) printf(">> File: %s  Func: %s\n", "main.c", __func__); else if(3 < 4) printf(">> File: %s  Func: %s  Line: %d\n", "main.c", __func__, 81); else printf(">> File: %s  Func: %s  Line: %d  STD:%ld\n", "main.c", __func__, 81, 201112L); printf(">> "); printf("Test Debug level = %d", 3); printf("\n\n");;
      if(4 < 2) printf(">> File: %s\n", "main.c"); else if(4 < 3) printf(">> File: %s  Func: %s\n", "main.c", __func__); else if(4 < 4) printf(">> File: %s  Func: %s  Line: %d\n", "main.c", __func__, 82); else printf(">> File: %s  Func: %s  Line: %d  STD:%ld\n", "main.c", __func__, 82, 201112L); printf(">> "); printf("Test Debug level = %d", 4); printf("\n\n");;
